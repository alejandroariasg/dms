...
<div class="left main-sidebar">
    ...
    <div class="sidebar-inner leftscroll">
        ...
        <ul>
                ...
                <li class="submenu">
                    <a href="#"><i class="fa fa-fw fa-table"></i> <span> Cliente/Proveedor/Emple </span> <span class="menu-arrow"></span></a>
                        <ul class="list-unstyled">
                            <li><a href="views/entidad/crear.php">Crear</a></li>
                            <li><a href="views/entidad/listar.php">Listar</a></li>
                        </ul>
                </li>
